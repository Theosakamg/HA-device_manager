...
Réinitialise le champ `ip` de **tous les équipements** à `NULL` dans la base de données. Les enregistrements des équipements sont conservés ; seules les adresses IP sont effacées.
