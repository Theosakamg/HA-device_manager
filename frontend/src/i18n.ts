...
const translations: { [lang: string]: Translations } = {
  en: {
    ...
    room: "Room",
    rooms: "Rooms",
    add_home: "Add Building",
    add_level: "Add Floor",
    add_room: "Add Room",
    edit_home: "Edit Building",
    edit_level: "Edit Floor",
    edit_room: "Edit Room",
    delete_home: "Delete Building",
    delete_level: "Delete Floor",
    delete_room: "Delete Room",
    no_homes: "No buildings yet. Create your first building!",
    no_levels: "No floors in this building.",
  ...
  fr: {
    ...
    room: "Pièce",
    rooms: "Pièces",
    add_home: "Ajouter un Bâtiment",
    add_level: "Ajouter un Étage",
    add_room: "Ajouter une Pièce",
    edit_home: "Modifier le Bâtiment",
    edit_level: "Modifier l'Étage",
    edit_room: "Modifier la Pièce",
    delete_home: "Supprimer le Bâtiment",
    delete_level: "Supprimer l'Étage",
    delete_room: "Supprimer la Pièce",
    no_homes: "Aucun bâtiment. Créez votre premier bâtiment !",
    no_levels: "Aucun étage dans ce bâtiment.",
