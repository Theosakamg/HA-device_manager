...
const translations: { [lang: string]: Translations } = {
  en: {
    ...
    edit: "Edit",
    clone: "Clone",
    tasmota_restart: "Restart device",
    tasmota_upgrade: "Upgrade firmware",
    add: "Add",
    close: "Close",
    confirm: "Confirm",
    loading: "Loading...",
  ...
  fr: {
    ...
    clone_device: "Dupliquer l'Équipement",
    ...
    edit: "Modifier",
    clone: "Dupliquer",
    tasmota_restart: "Redémarrer l'appareil",
    tasmota_upgrade: "Mettre à jour le firmware",
    add: "Ajouter",
    close: "Fermer",
    confirm: "Confirmer",
    loading: "Chargement...",
