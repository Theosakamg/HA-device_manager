...
const translations: { [lang: string]: Translations } = {
  en: {
    ...
    config_prov_desc: "Configure credentials and addresses used during device deployment and network scanning.",
    config_scan_section: "Network Scan (SSH)",
    config_scan_ssh_key_file: "SSH Key File",
    config_scan_ssh_key_file_hint: "Absolute path to the private key stored in /config/dm/keys/",
    config_scan_ssh_key_upload: "Upload Private Key",
    config_scan_ssh_key_upload_hint: "Upload the SSH private key file (will be stored in /config/dm/keys/ with mode 0600)",
    ...
    config_scan_ssh_user_hint: "Username for SSH connection to the router (e.g. root)",
    config_scan_ssh_host: "SSH Host",
    config_scan_ssh_host_hint: "IP address or hostname of the router (e.g. 192.168.0.254)",
    config_device_section: "Device Access",
    config_device_pass: "Device Password",
    config_device_pass_hint: "Web interface password for devices (Tasmota / WLED)",
    ...
    config_bridge_host_hint: "SSH address of the Zigbee2MQTT host (user@host, optional)",
    config_bridge_devices_config_path: "Devices Config Path",
    config_bridge_devices_config_path_hint: "Remote path to the Zigbee2MQTT devices.yaml file",
    // Maintenance
  ...
  fr: {
    ...
    // Provisioning settings
    config_prov_title: "Provisioning",
    config_prov_desc: "Configurez les identifiants et adresses utilisés lors du déploiement des équipements et du scan réseau.",
    config_scan_section: "Scan Réseau (SSH)",
    config_scan_ssh_key_file: "Fichier clé SSH",
    config_scan_ssh_key_file_hint: "Chemin absolu vers la clé stockée dans /config/dm/keys/",
    config_scan_ssh_key_upload: "Envoyer la clé privée",
    config_scan_ssh_key_upload_hint: "Téléverser le fichier de clé privée SSH (stocké dans /config/dm/keys/ avec les droits 0600)",
    ...
    config_scan_ssh_user_hint: "Nom d'utilisateur pour la connexion SSH au routeur (ex: root)",
    config_scan_ssh_host: "Hôte SSH",
    config_scan_ssh_host_hint: "Adresse IP ou hostname du routeur (ex: 192.168.0.254)",
    config_device_section: "Accès Appareil",
    config_device_pass: "Mot de passe appareil",
    config_device_pass_hint: "Mot de passe de l'interface web des appareils (Tasmota / WLED)",
    config_ntp_section: "NTP",
    config_ntp_server1: "Serveur NTP",
    config_ntp_server1_hint: "Adresse du serveur NTP principal (ex: pool.ntp.org)",
    config_wifi_section: "WiFi",
    ...
    config_wifi2_password_hint: "Mot de passe du réseau WiFi de secours (optionnel)",
    ...
    config_bridge_host_hint: "Adresse SSH de l'hôte Zigbee2MQTT (user@host, optionnel)",
    config_bridge_devices_config_path: "Chemin de la config",
    config_bridge_devices_config_path_hint: "Chemin distant vers le fichier devices.yaml de Zigbee2MQTT",
